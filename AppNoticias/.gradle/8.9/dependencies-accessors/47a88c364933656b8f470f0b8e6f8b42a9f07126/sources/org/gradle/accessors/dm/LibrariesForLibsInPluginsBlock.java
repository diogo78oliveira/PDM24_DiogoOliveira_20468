...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final NewsLibraryAccessors laccForNewsLibraryAccessors = new NewsLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>news</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public NewsLibraryAccessors getNews() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForNewsLibraryAccessors;
    }
     ...
     */
    @Deprecated
    public static class NewsLibraryAccessors extends SubDependencyFactory {
        private final NewsApiLibraryAccessors laccForNewsApiLibraryAccessors = new NewsApiLibraryAccessors(owner);

        public NewsLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>news.api</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public NewsApiLibraryAccessors getApi() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForNewsApiLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class NewsApiLibraryAccessors extends SubDependencyFactory {

        public NewsApiLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>java</b> with <b>com.github.KwabenBerko:News-API-Java</b> coordinates and
         * with version reference <b>newsApiJava</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>newsApiJava</b> with value <b>1.0.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getNewsApiJava() { return getVersion("newsApiJava"); }
